...
class RandAugmentPolicy(object):
    ...
    def __init__(self, fillcolor=(0, 0, 0), N=2, M=9):
    # def __init__(self, fillcolor=(255, 255, 255), N=1, M=5):
        self.policies = ['posterize', 'rotate', 'equalize', 'autocontrast', 'color', 'contrast', 'shearX', 'brightness', 'sharpness', 'shearY', "translateX", "translateY","cutout"]
